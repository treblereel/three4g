...
@Three4gElement(paths = {"js/loaders/BVHLoader.js"})
...
public class BVHLoader {
   ...
   */
  public native void load(String url, OnLoadCallback<JsPropertyMap> onLoad);
  ...
  public native void load(
      String url, OnLoadCallback<JsPropertyMap> onLoad, OnProgressCallback onProgress);
  ...
  public native void load(
      String url,
      OnLoadCallback<JsPropertyMap> onLoad,
   ...
   * @return instance of BVHLoader
   */
  public native BVHLoader setPath(String path);
}
