 ...
 * To use this, as with all files in the /extensions directory, you will have to include the file seperately in your HTML.
 *
 * @author Dmitrii Tikhomirov
 * Created by treblereel on 3/13/18.
 */
@Three4gElement(paths = "js/controls/OrbitControls.js")
