...
@Three4gElement(paths = {"js/libs/jszip.min.js", "js/loaders/AMFLoader.js"})
@JsType(isNative = true, namespace = "THREE")
public class AMFLoader {
   ...
   * @return instance of AMFLoader
   */
  public native AMFLoader setPath(String path);
}
