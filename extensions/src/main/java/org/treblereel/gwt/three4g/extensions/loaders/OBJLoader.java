...
/**
 * A loader for loading a .obj resource. The OBJ file format is a simple data-format that represents
 * 3D geometry in a human readable format as the position of each vertex, the UV position of each
 * texture coordinate vertex, vertex normals, and the faces that make each polygon defined as a list
...
@Three4gElement(
    paths = {
      "js/loaders/deprecated/LegacyJSONLoader.js",
      "js/loaders/OBJLoader.js",
      "js/loaders/LoaderSupport.js",
...
public class OBJLoader {
   ...
   *
   * @param url — A string containing the path/URL of the .obj file.
   * @param onLoad — A function to be called after the loading is successfully completed. The
   *     function receives the loaded Object3D as an argument.
   */
   ...
   *     be the XMLHttpRequest instance, that contains .total and .loaded bytes.
   */
  public native void load(
      String url, OnLoadCallback<? extends Object3D> onLoad, OnProgressCallback onProgress);
  ...
  public native void load(
      String url,
      OnLoadCallback<? extends Object3D> onLoad,
   ...
   *     MeshPhongMaterial. If an obj object or group uses multiple materials while declaring faces,
   *     geometry groups and an array of materials are used.
   */
